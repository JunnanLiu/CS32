...
using namespace std;
Sequence::Sequence(): strLength(0){}   // Create an empty sequence (i.e., one whose size() is 0).
...
{
    if(pos < 0||pos > strLength) // only 1 item, strLength = 1, pos can be 1, means the end of sequence
    {
        return false;
    }
    else
