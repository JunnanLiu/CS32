...
//  Homework3
//
//  Created by Junnan Liu on 2/14/17.
...
{
    if (n2 <= 0)  // The empty sequence appears in a sequence of length n1 in 1 way, even if n1 is 0.
        return 1;
    if (n1 < n2)
        return 0;
    int i = countIncludes(a1+1, n1-1, a2, n2);
    if (a1[0] == a2[0])
        return i + countIncludes(a1+1, n1-1, a2+1, n2-1);
    return i;
}
...
// permutation排列，置换 of its original value such that
